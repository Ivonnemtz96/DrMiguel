              ...
              <div id="divPadre">
                  ...
                  <div id="divHijo">
                      ...
                      <div style="margin: 20px 50px 50px 50px;">
                          <div>
                            <img style="width:200px" src="http://drmiguelblanco.com/assets/images/logo/02.png">
                          </div>
                          ...
                          <div class="container">                    
                              ...
                              <div style="width:100%; display: inline-block;">          
                                  <div style="margin-bottom: 30px;">
                                        <h3><b>' . $nombre . ', ¡gracias por escribirnos!</h3>
                                        <p>Recibimos tu mensaje, alguien de nuestro equipo se pondrá en contacto contigo para agendar tu cita o contestar tus dudas.</p>
                                        <p style="margin-bottom: 15px; font-size: 12px;">Dr. Miguel Blanco 2024. Todos los derechos reservados Banana Group Marketing</p>
                                  </div>
                              </div>
