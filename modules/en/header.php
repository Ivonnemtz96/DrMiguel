                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex">
                            <ul class="contact-list d-flex flex-wrap align-items-center list-unstyled mb-0 mr-30">
                                <li>
                                    <i class="icon-location"></i><a href="https://maps.app.goo.gl/UGNRxC8JWsutBoXg6" target="_blank">Address: Calle Ignacio Zaragoza, San José
                                        del Cabo</a>
                                </li>
                                <!-- <li>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item has-dropdown dropdown d-block d-lg-none">
                        ...
                        <ul class="dropdown-menu">
                            <li class="nav-item">
                                <a href="?lang=es" class="nav-item-link">Spanish</a>
                            </li><!-- /.nav-item -->
                            <li class="nav-item">
                                <a href="?lang=en" class="nav-item-link">English</a>
                            </li><!-- /.nav-item -->
                        </ul><!-- /.dropdown-menu -->
                    </li>
                </ul>
